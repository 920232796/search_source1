...
def main():
    ...
    #
    # res = requests.get("https://pan.baidu.com/pcloud/friend/getfollowlist?query_uk=1404980556&limit=24&start=0", headers=headers)
    #
    # print(res.status_code)
    # print(res.content)
    # print(res.text)
    ...
    # res1 = requests.get("https://pan.baidu.com/share/home?uk=3273190291#category/type=1&suk=NXzF4XYbca41YiS-ftYoCg", headers = headers)
    # import time
    # time.sleep(2)
    # res1 = requests.get("https://pan.baidu.com/share/home?uk=3273190291#category/type=2&suk=NXzF4XYbca41YiS-ftYoCg",
    #                     headers=headers)
    # print(res1.status_code)
    # print(res1.content)
    # search_obj = re.search("""<span class="follow">(.*)</span>""", res1.text, re.M|re.I)
    # print(search_obj.group(1))
    #
    # # search_o = re.search("""ni (.*) "ss" hahaha""", """ni hao "ss" hahaha""", re.M|re.I)
    # # print(search_o.group(1))

    # with open("./spider_cookie.txt", "r") as f:
    #     # print(f.read())
    #     content = f.read()
    #
    ...
    #
    # cookie = {}
    # for each_cookie in content_list:
    #     name, value = each_cookie.strip().split('=', 1)
    #     cookie[name] = value
    #
    # print(cookie)
